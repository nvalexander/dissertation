apt-get install libcairo2-dev libxt-dev r-cran-ggplot2 r-cran-stringr r-cran-plyr r-cran-gridextra r-cran-xtable r-cran-reshape r-cran-cairodevice r-cran-rcurl r-cran-multcomp texlive-luatex
